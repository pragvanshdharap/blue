/* ads131m08.h
 * Multi-instance driver API for ADS131M08 (STM32 HAL)
 * Includes register definitions from TI datasheet.
 */
...
/* Channel configuration registers: each channel has 5 (0x09 – 0x30) */
...
/* ------------------------- MODE Register Bits ------------------------- */
#define ADS131M08_MODE_WLENGTH_MASK   (3u << 8)   /* word length */
#define ADS131M08_MODE_OSR_MASK       (0x7u << 2) /* oversampling ratio */
#define ADS131M08_MODE_CHOP_MASK      (1u << 0)

/* ------------------------- CLOCK Register Bits ------------------------ */
#define ADS131M08_CLOCK_CLKSEL_MASK   (1u << 8)
#define ADS131M08_CLOCK_CLKDIV_MASK   (0x7u << 0)

/* ------------------------- GAIN1 / GAIN2 Bits ------------------------- */
#define ADS131M08_GAINx_PGA_MASK(ch)  (0x7u << (((ch) % 4) * 4))
